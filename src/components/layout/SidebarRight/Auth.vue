<template>
  <div class="border rounded-xl p-4 ">
    ...
    <div class="flex items-center gap-2 my-3">
      <div class="border border-zinc-300/50 border-[0.1px] h-[1px] w-1/2 "></div>
      or
    ...
    <div v-if="isLargeScreen">
      ...
      <p class="text-xs mt-2 text-zinc-500">
        ...
        Policy</span>, including <span class="text-link">Cookie Use</span>.</p>
      <p class="text-base mt-4 mb-2 font-bold">Already have an account?</p>
      <LoginDialog/>
