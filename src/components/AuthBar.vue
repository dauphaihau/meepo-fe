<template>
  <div
      ...
      class="
        fixed bottom-0 md:bottom-0 left-0 z-[2]
  ...
  >
    <div class="text-white mb-3">
      <p class="text-xl font-semibold">Don't miss what's happening</p>
      <p class="text-sm">People on Meepo are the first to know.</p>
    </div>
